...
module.exports = {
  ...
  detailedDescription: 'Use `k!patch` to get the latest patch notes, with key changes summary and link to the official League of Legends patch notes website.',
  ...
  async execute(message) {
    try {
      ...
      if (patchData) {
        ...
        message.reply("Could not fetch the latest patch notes. Please try again later.");
      }
    } catch (error) {
